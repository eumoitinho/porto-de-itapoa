...
import {
  ...
  usePortal,
  useToast
} from "./chunk-AP4B6H4R.js";
import {
  require_dist
} from "./chunk-2TAKL77W.js";
import {
  require_jsx_runtime
} from "./chunk-T3FNONAL.js";
import {
  require_react
} from "./chunk-XTTSKKEN.js";
import {
  __commonJS,
  __toESM
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-URQGLRGA.js")
});
...
var DocumentPerspectiveList = (0, import_react2.memo)(function() {
  ...
  } = useSingleDocRelease(), handlePerspectiveChange = (0, import_react2.useCallback)((perspective) => () => {
  ...
  }, [setPerspective, setParams, params, defaultPerspective, onSetScheduledDraftPerspective]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : false, isPublishedChipDisabled = (0, import_react2.useMemo)(() => isLiveEdit && !selectedReleaseId ? false : !editState?.published, [isLiveEdit, selectedReleaseId, editState?.published]), getReleaseChipState = (0, import_react2.useCallback)((release) => {
    if (!params?.historyVersion) {
...
var DocumentPaneProviderWrapper = (0, import_react2.memo)((props) => {
  const $ = (0, import_react_compiler_runtime.c)(9), source = useSource(), {
    setParams,
    params
  } = usePaneRouter();
  let t0;
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-HTI5QXQ2.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-KZEDINBK.js"))
};
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-7RPRO5QC.js")),
...
//# sourceMappingURL=chunk-IEE3E5XQ.js.map
